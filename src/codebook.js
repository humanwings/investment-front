...
// export const stockMap = new Map(stockArray)
// export const buyMap = new Map(buyArray)
// export const sellMap = new Map(sellArray)

// console.log(stockArray[5][1]);
// console.log(stockMap.get('21'));

export const tacticsOptions = [
    {
        value: tacticsArray[0][0],
        label: tacticsArray[0][1],
        children : stockArray.map( v => { return {value: v[0], label: v[1]}} )
    }, 
    {
        value: tacticsArray[1][0],
        label: tacticsArray[1][1],
        children: buyArray.map( v => { return {value: v[0], label: v[1]}} )
    }, 
    {
        value: tacticsArray[2][0],
        label: tacticsArray[2][1],
        children: sellArray.map( v => { return {value: v[0], label: v[1]}} )
    }
]

/**把子策略拼成一个map */
export const tacticsMap = new Map([
    ...stockArray.map( v => { return [tacticsOptions[0].value + v[0], v[1]]} ),
    ...buyArray.map( v => { return [tacticsOptions[1].value + v[0], v[1]]} ),
    ...sellArray.map( v => { return [tacticsOptions[2].value + v[0], v[1]]} ),
])

export const colorArray = ['Gray', 'Green', 'Red']
...
// export const rankColors = ['#99A9BF', '#F7BA2A', '#FF9900'] 
export const rankColors = ['grey', 'blue', 'red'] 


/* 以下为 公司估值 模块 的 code 定义  */
export const deviationFilter = [
    { text: 'TOP10', value: '01' }, 
    { text: '前10%', value: '02' }, 
    { text: '>100%', value: '03' }, 
    { text: '>50%', value: '04' },
